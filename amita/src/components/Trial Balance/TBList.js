...
function TBList() {
  ...
  const handleDetailClick = (filtered) => {
    ...
    dispatch(setAccDocType(filtered.Debit));
    dispatch(setStatusName(filtered.Credit));
    navigate(`/uitestacc/GLList?journalNo=${filtered.JournalNo}`); 
  };
    ...
    //   console.log("AccDocNo:", filtered.JournalNo); 
      //http://203.154.140.51/accreport?Form=GeneralLedger&Code=1111-40&DateFrom=2025-01-01&DateTo=2025-12-31
      //http://203.154.140.51/accreport/form?Form=GeneralLedger&Code=SI25030001&DateFrom=2025-01-01&DateTo=2025-12-31
