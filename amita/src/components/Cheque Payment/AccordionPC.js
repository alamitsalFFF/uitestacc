...
import AccordionPIHD from "./AccordionPCHD";
import AccordionPIDT from "./AccordionPCDT";
import AccordionPCHD from "./AccordionPCHD";
import AccordionPCDT from "./AccordionPCDT";
import FloatingActionBar from "../DataFilters/FloatingActionBar";

export default function AccordionPC() {
  ...
  useEffect(() => {
    const fetchCategoryOptions = async () => {
      try {
        const categoryApiUrl = `${API_BASE}/DocConfig/GetDocConfig?category=PC`; //TYPEDOC
  ...
  useEffect(() => {
    const fetchWebAddress = async () => {
      try {
        console.log("category", category);
        const WebAddressAPI = `${API_BASE}/Module/GetModuleMenu?MenuID=PC`;
