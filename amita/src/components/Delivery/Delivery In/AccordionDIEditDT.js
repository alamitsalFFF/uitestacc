...
// import { useLocation, useNavigate, useSearchParams } from "react-router-dom"; // ไม่ได้ใช้ในโค้ดนี้
...
// import Divider from "@mui/material/Divider"; // ไม่ได้ใช้
import InputLabel from "@mui/material/InputLabel";
import MenuItem from "@mui/material/MenuItem";
import FormControl from "@mui/material/FormControl";
import Select from "@mui/material/Select";
import Swal from "sweetalert2";
// import { setAddProducts, setAccDocNo } from "../../redux/TransactionDataaction"; // ไม่ได้ใช้
// import { useSelector, useDispatch } from "react-redux"; // ไม่ได้ใช้
import { formatNumber } from "../../purchase/formatNumber";
import { useAuthFetch } from "../../Auth/fetchConfig";
import { API_BASE } from "../../api/url";
import MoreInfoDT from "../../AdditionData/AdditionDataTD/MoreInfoDT";
// import ButtonAction from "../../DataFilters/ButtonAction"; // ไม่ได้ใช้
...
function AccordionDIEditDT({
  ...
  const [adddatadetail, setdAddataDetail] = useState({
    ...
    rateVat: 0, // กำหนดค่าเริ่มต้นเป็นตัวเลข
    rateWht: 0,
    vatType: 0,
      ...
      const loadData = async () => {
        try {
          ...
          if (data && data.length > 0) {
            ...
            setSaleProductCode(itemData.saleProductCode || "");
            setDocStatus(
  ...
  const handleUpdate = async () => {
    ...
    const updatedProduct = {
      ...
      // ส่งค่า Vat, Wht, VatType ไป update
              ...
              >
                {isEditing ? (
                  ...
                  >
                    ...
                    &nbsp;{saleProductCode}/{salesDescriptionValue} &nbsp;
                    <i>
...
export default AccordionDIEditDT;