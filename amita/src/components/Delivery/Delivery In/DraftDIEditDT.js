...
function OCRDraftDIEditDT({
  ...
  const handleConfirmProductSelection = (product) => {
    ...
    setdAddataDetail((prev) => ({
      ...
      rateVat: product.rateVat !== undefined && product.rateVat !== null ? product.rateVat.toString() : prev.rateVat,
      rateWht: product.rateWht !== undefined && product.rateWht !== null ? product.rateWht.toString() : prev.rateWht,
      vatType: product.vatType !== undefined && product.vatType !== null ? product.vatType.toString() : prev.vatType,
    }));
...
export default OCRDraftDIEditDT;
