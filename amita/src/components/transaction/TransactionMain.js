...
import AccordionDOHD from "../Delivery/Delivery Out/AccordionDOHD";
...
export default function TransactionMain() {
  ...
  const [currentAccDocType, setCurrentAccDocType] = useState("");
      ...
      >
        ...
        <AccordionDetails>
          <TransactionHeader
            ...
            setCurrentAccDocType={setCurrentAccDocType}
          />
        </AccordionDetails>
      </Accordion>
      <Accordion
