...
function PIDTList() {
  ...
  return (
    <div>
      <h1 style={{ textAlign: "center" }}>Payment Invoice</h1>
      <div className="row">
        <ListItem
          style={{
            display: "flex",
        ...
        >
          <p>
            Date:
            {pih && pih.length > 0 && (
              <FormatDate dateString={pih[0].AccEffectiveDate} />
            )}
          </p>
        </ListItem>
      </div>
      <div className="row">
        <ListItem style={{ display: "flex", alignItems: "center" }}>
          ...
          <h5>
            ...
            {/* &nbsp;{partyName} */}
            &nbsp;{pih && pih.length > 0 && pih[0].PartyName}
          </h5>
        </ListItem>
      </div>
      {pid.map((product, index) => (
