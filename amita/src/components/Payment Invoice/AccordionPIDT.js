...
function AccordionPIDT({ accDocNo,onSaveSuccess }) {
      ...
      (async () => {
        try {
          ...
          if (responseH.status === 200 && responseD.status === 200) {
            setLoading(false);
            console.log("vAP_H:", responseH.data);
            console.log("vAP_D:", responseD.data);
      ...
      (async () => {
        try {
          ...
          if (responseH.status === 200 && responseD.status === 200) {
            ...
            console.log("Sorted vAP_D:", sortedData);
            setDIH(responseH.data);
            setDID(sortedData);
          } else {
            setLoading(false);
  ...
  const [addDetail, setAddDetail] = useState([]);
   ...
   console.log("handleEditDetail called. Modal state:", true);
    ...
    }, [fetchDataDIDetails, handleCloseEditDetailModal]);
