...
import AccordionRVDT from "./AccordionRVDT";
import FloatingActionBar from "../DataFilters/FloatingActionBar";
import AccordionRVHD from "./AccordionRVHD";

export default function AccordionRV() {
  ...
  useEffect(() => {
    ...
    if (j && j !== currentAccDocNo) {
      ...
      setExpandedPanels?.({ panel1: true, panel2: true });
      console.log("AccordionRV: init currentAccDocNo from URL:", j);
    }
  }, [location.search]);
