...
import AccordionQuickPaymentMain from "./AccordionQuickPaymentMain";
import AccordionQuickPaymentResult from "./AccordionQuickPaymantResult";
import { URL } from "../api/url";
import HeaderBar from "../menu/HeaderBar";
import FloatingActionBar from "../DataFilters/FloatingActionBar";

export default function AccordionQP() {
      ...
      <div className="col-12" style={{ display: "flex", justifyContent: "space-between" }}>
        <div className="col-8">
          <div className="docconfig-header">
            ...
            <p className="docconfig-subtitle">รายวันจ่าย</p>
          </div>
        </div>
        <div className="col-4">
          <HeaderBar />
      ...
      >
        ...
        <AccordionDetails>
          {apiData ? ( // แสดงตารางก็ต่อเมื่อมีข้อมูลแล้ว
            <AccordionQuickPaymentResult data={apiData} /> // ส่งข้อมูลไปเป็น Props
          ) : (
