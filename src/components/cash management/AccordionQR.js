...
import AccordionQuickReceiveMain from "./AccordionQuickReceiveMain";
import AccordionQuickReceiveResult from "./AccordionQuickReceiveResult";
import { URL } from "../api/url";
import FloatingActionBar from "../DataFilters/FloatingActionBar";
import HeaderBar from "../menu/HeaderBar";

export default function AccordionQR() {
      ...
      <div className="col-12" style={{ display: "flex", justifyContent: "space-between" }}>
        <div className="col-8">
          <div className="docconfig-header">
            ...
            <p className="docconfig-subtitle">รายวันรับ</p>
          </div>
        </div>
        <div className="col-4">
          <HeaderBar />
      ...
      >
        ...
        <AccordionDetails>
          {apiData ? ( // แสดงตารางก็ต่อเมื่อมีข้อมูลแล้ว
            <AccordionQuickReceiveResult data={apiData} /> // ส่งข้อมูลไปเป็น Props
          ) : (
