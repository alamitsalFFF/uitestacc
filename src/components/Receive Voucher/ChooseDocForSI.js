...
/**
 * ChooseDocForSI
 * Modal สำหรับเลือกเอกสาร SI (Sales Invoice) เพื่อสร้าง RV
 *
 * Props:
 *   isOpen    {boolean}
 *   onClose   {fn}
 ...
 */
function ChooseDocForSI({ isOpen, onClose, onSelect }) {
  ...
  useEffect(() => {
    ...
    const fetchSIList = async () => {
      ...
      try {
        ...
        console.error("ChooseDocForSI fetch error:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <>
      ...
      {/* Modal panel — purple/deep-orange theme for SI */}
      <div
        style={{
          position: "fixed",
          top: "50%",
          ...
          background: "#fff",
          borderRadius: "20px",
          boxShadow: "0 8px 32px rgba(106,27,154,0.22)",
      ...
      >
        ...
        {/* Search bar */}
        <div style={{ padding: "12px 16px", flexShrink: 0, background: "#f3e5f5" }}>
          <TextField
            size="small"
            fullWidth
            placeholder="ค้นหา SI No. หรือชื่อลูกค้า..."
            value={searchTerm}
              ...
              startAdornment: (
                <InputAdornment position="start">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#8e24aa", fontSize: "0.9rem" }}
                  />
                </InputAdornment>
              ),
            ...
            filtered.map((doc, i) => (
              <div
                ...
                style={{
                  ...
                  margin: "5px 0",
                  padding: "10px 14px",
                  boxShadow: "0 1px 4px rgba(106,27,154,0.10)",
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
                    <span style={{ fontWeight: 700, color: "#4a148c", fontSize: "0.95rem" }}>
                      {doc.AccDocNo}
                    </span>
                    <span style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px", flexShrink: 0, marginLeft: "12px" }}>
                  <span style={{ fontSize: "1.05rem", fontWeight: 700, color: "#4a148c", whiteSpace: "nowrap" }}>
                    {formatNumber(doc.TotalNet)}
                  </span>
                  <FontAwesomeIcon
                    icon={faChevronRight}
                    style={{ color: "#8e24aa", background: "#e1bee7", borderRadius: "50%", padding: "6px", fontSize: "0.75rem" }}
                  />
                </div>
              </div>
            ))
