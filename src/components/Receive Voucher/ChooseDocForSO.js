...
/**
 * ChooseDocForSO
 * Modal สำหรับเลือกเอกสาร SO (Sales Order) เพื่อสร้าง RV
 *
 * Props:
 ...
 */
function ChooseDocForSO({ isOpen, onClose, onSelect }) {
  ...
  useEffect(() => {
    ...
    const fetchSOList = async () => {
      ...
      try {
        ...
        console.error("ChooseDocForSO fetch error:", err);
      } finally {
        setLoading(false);
      }
    };
    ...
    <>
      ...
      <div
        style={{
          ...
          background: "#fff",
          borderRadius: "20px",
          boxShadow: "0 8px 32px rgba(230,81,0,0.20)",
      ...
      >
        {/* Header — orange theme สำหรับ Sales */}
        <div
          style={{
        ...
        {/* Search bar */}
        <div style={{ padding: "12px 16px", flexShrink: 0, background: "#fff3e0" }}>
          <TextField
            size="small"
            fullWidth
            placeholder="ค้นหา SO No. หรือชื่อลูกค้า..."
            value={searchTerm}
            ...
            filtered.map((doc, i) => (
              <div
                ...
                style={{
                  ...
                  margin: "5px 0",
                  padding: "10px 14px",
                  boxShadow: "0 1px 4px rgba(230,81,0,0.10)",
