...
import AccordiionDIAddDT from "../Delivery In/AccordiionDIAddDT.js";
import AccordionSelectProductDI from "../Delivery In/AccordionSelectProductDI.js";
import AccordionDIEditDT from "../Delivery In/AccordionDIEditDT.js";
import DIManagementComponentFromPO from "../Delivery In/DIManagementComponentFromPO.js";
import AccordiionDOAddDT from "./AccordiionDOAddDT.js";
import AccordionSelectProductDO from "./AccordionSelectProductDO.js";
      ...
      (async () => {
        try {
          ...
          if (responseH.status === 200 && responseD.status === 200) {
            ...
            console.log("Sorted vDO_D:", sortedData);
            setDOH(responseH.data);
            setDOD(sortedData);
          } else {
            setLoading(false);
      ...
      <div className="row">
        ...
        >
          ...
          >
            ...
            >
              Date:&nbsp;
              {doh && doh.length > 0 && doh[0]?.AccBatchDate && (
