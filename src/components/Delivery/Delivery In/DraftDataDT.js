...
import DraftDataEdit from "./DraftDataDIEdit.js";

function DraftDataDT({ accDocNo, initialOcrDetails, onSaveSuccess }) {
    ...
    // 2. ถ้าเป็น Draft ใหม่ (ไม่มี AccDocNo) และมีข้อมูล OCR Detail มา
      ...
      if (mappedOCR) {
        setOcrTotals({
          ...
          WHTAmount: mappedOCR.WHTAmount || 0, // VAT Amount
