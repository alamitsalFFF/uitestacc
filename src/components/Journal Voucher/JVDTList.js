...
function JVDTList() {
    ...
    if (JournalNo) {
      ...
      const vJournal_All = {
        ...
        parameters: [
          ...
          { field: "JournalNo", value: JournalNo },
        ],
        results: [
          { sourceField: "EntryId" },
  ...
  useEffect(() => {
   ...
   const handlePrint = async () => {
    ...
    // const printUrl = `http://203.154.140.51/accreport/form?Form=Form${GL}&Code=${JournalNo}`;
