import AccordionSelectProductSO from "./AccordionSelectProductSO";
...
function AccordionSOEditDT({
  ...
  const fetchData = async (accDocNo, accItemNo) => {
    console.log("Fetching data for:", accDocNo, accItemNo);
    try {
...
export default AccordionSOEditDT;
